object PhpEditForm: TPhpEditForm
  Left = 396
  Top = 274
  Width = 575
  Height = 499
  ...
  object Edit: TEasyEdit
    ...
    Options = [eoPaintGutter, eoPaintMargin, eoOverwriteBlocks, eoEnableDragging, eoEnableSearchHighlight, eoEnableSelection, eoSelectBeyondEol, eoForceCutCopy, eoLineStyleBeyondEol, eoInvertLineStyle, eoThumbTracking, eoFindTextAtCursor, eoTripleClickLine]
    ...
    WantTabs = True
    CodeParamChars = '.'
    OnBeforeInsertPopup = EditBeforeInsertPopup
