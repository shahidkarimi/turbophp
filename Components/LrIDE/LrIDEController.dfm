object LrIDEControllerModule: TLrIDEControllerModule
  ...
  object ActionList: TActionList
    ...
    object LrSaveAsAction: TAction
      ...
      OnUpdate = LrSaveAsActionUpdate
    end
    object LrCloseAction: TAction
      Category = 'File'
      Caption = 'Close'
      OnExecute = LrCloseActionExecute
      OnUpdate = LrCloseActionUpdate
    end
    object LrCloseAllAction: TAction
      Category = 'File'
      Caption = 'Close All'
      OnExecute = LrCloseAllActionExecute
      OnUpdate = LrCloseActionUpdate
    end
    object LrSaveOrSaveAsAction: TAction
      Category = 'File'
      Caption = 'Save'
      ImageIndex = 2
      OnExecute = LrSaveActionExecute
